...
namespace Sales_Web_MVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1998, 7, 26), 1000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1999, 4, 2), 1000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1980, 10, 1), 1000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alexx@gmail.com", new DateTime(1997, 4, 4), 1000.0, d2);
